...
2. Check whether SD already has a matching `_SD` extension point, or whether the feature belongs to an existing inherited subtree such as `_DV`, `Corvax`, `Nyanotrasen`, or another present owner.
