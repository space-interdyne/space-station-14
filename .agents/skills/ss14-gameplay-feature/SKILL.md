...
1. Open [sd-gameplay-map.md](references/sd-gameplay-map.md) first.
- Use it to map the request to assemblies, domain folders, paired resource files, and fork-specific `_SD` areas.
...
- `references/sd-gameplay-map.md`: repo-specific subsystem map, folder routing, `_SD` extensions, and common pairings between code and resources.
