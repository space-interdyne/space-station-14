...
Prefer XAML-first UI, client-side presentation, and reading already-networked state before duplicating UI state. Put SD-only client UI under `Content.Client/_SD/`.
