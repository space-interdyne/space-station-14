...
Shared code owns replicated state, shared events, and prediction-aware logic. Put SD-only shared contracts under `Content.Shared/_SD/`. Do not add direct client-only or server-only dependencies here.
