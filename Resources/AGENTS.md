...
Use the narrowest existing subtree, put SD-only content under `Resources/**/_SD/`, keep parent prototypes in `base.yml` when you start a new parent tree, and validate YAML or RSI metadata after edits.
